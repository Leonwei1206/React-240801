        ...
        <div className="d-flex flex-row-reverse" id="Topicsflextitle">
          <div className="p-2" id="Topicstitle">
            ...
            <img
              src={Gif004}
              alt="烏雲打雷"
              style={{ height: "50px", width: "50px", marginRight: "150px" }}
            />
          </div>
          ...
          <div className="p-2" style={{ width: "50%" }} id="upbg">
            ...
            <div className="motivationtext2">
              <ol>
                <li>
                  設計鞋業智能製造系統 :
                  包含派工、生產回報、生產監控三項功能模組並導入NFC
                  TAG。從主管派工、員工回報生產進度，以及生產進度的監控，都不再需要依賴紙本，而是使用WEB及APP進行操作，並將資訊紀錄於資料庫，達到資訊有效管理並能即時監控的效益。
                </li>
                <br/>
                <li>
                  設計防偽驗證系統 : 包含鞋子資訊紀錄及感應驗證模組，並導入NFC
                  TAG將其植入鞋中。每一雙鞋會對應一張NFC TAG，利用NFC TAG
                  中UID唯一且不可更改的特性，作為判別鞋子是否為正品的依據，同時確保資訊不會被隨意竄改也不會重複，達到防偽的目的。
                </li>
                {/* 繼續添加其他段落 */}
              </ol>
            </div>
