      ...
      <div className="p-2" id="z-index13">
        <div className="d-flex flex-column-reverse">
          ...
          <div className="p-2"id="completion2">
            {/* 心得文字 */}
            前面提到這專題是由三個人分工完成的，我負責的是資料庫、Excel檔匯入及監控的部分，
            是一點一點的累積，從最剛開始與教授和鞋廠廠商了解鞋業的流程還有遇到的問題，下去一步一步的推進，
            雖然看似很容易，每次討論完需求及呈現方式後，到製作出大家都滿意的狀況需要花不少時間。
            了解廠商的需求後，我們開始分工並且踏出第一步，過程中碰到困難，
            可能需要debug、功能無法呈現、API串接出了問題等等，都必須去解決，
            所以團隊就有了討論，不同的人看到的事情與思考方式都大不相同，所以往往都能給彼此不同的思考方向，
            除了彼此討論之外，還會上網尋找解決問題的方法，雖然在單一問題要花上好幾天的時間才解決掉，
            但解決完後的成就感把先前的灰心一鼓作氣地打倒，繼續往前，就這樣一步一步的完成了我們的專題。
          </div>
          </div>
